      ...
      <motion.div variants={framer.aboutContain} className={styles.aboutContain}>
        <section className={styles.introSec}>
          <article className={styles.introLeft}>
            ...
            <motion.h2 variants={framer.ability}>개발자를 위한 개발을 하는 개발자</motion.h2>
            <motion.div variants={framer.ability} className={styles.introDesc}>
          ...
          <motion.article variants={framer.ability} className={styles.introRight}>
